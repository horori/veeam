...
- [Veeam:](#veeam)
  - [### _a cookbook to deploy Veeam Backup and Replication server_](#h3-ida-cookbook-to-deploy-veeam-backup-and-replication-server-34a-cookbook-to-deploy-veeam-backup-and-replication-serverh3)
  - [Table of Contents](#table-of-contents)
  - [Requirements](#requirements)
    - [Platforms](#platforms)
      - [_Note regarding SQL Express Requirements:_](#note-regarding-sql-express-requirements)
    - [Chef](#chef)
    - [Cookbooks](#cookbooks)
  ...
  - [Matchers/Helpers](#matchershelpers)
    ...
    - [Veeam::Helper](#veeamhelper)
      ...
      - [find_update_url(version)](#find_update_urlversion)
      - [find_update_checksum(version)](#find_update_checksumversion)
      - [prerequisites_list](#prerequisites_list)
      - [explorers_list](#explorers_list)
      - [find_current_dotnet](#find_current_dotnet)
      - [validate_powershell_out(script, timeout: nil)](#validate_powershell_outscript-timeout-nil)
      - [find_current_veeam_solutions(package_name)](#find_current_veeam_solutionspackage_name)
      - [find_current_veeam_version(package_name)](#find_current_veeam_versionpackage_name)
      - [iso_installer(downloaded_file_name, new_resource)](#iso_installerdownloaded_file_name-new_resource)
      - [extract_installer(downloaded_file_name, new_resource)](#extract_installerdownloaded_file_name-new_resource)
      - [unmount_installer(downloaded_file_name)](#unmount_installerdownloaded_file_name)
      - [get_media_installer_location(downloaded_file_name)](#get_media_installer_locationdownloaded_file_name)
...
| **Update 4b** | [VeeamBackup&Replication_9.5.4.2866.Update4b_20191210.iso](https://download2.veeam.com/VeeamBackup&Replication_9.5.4.2866.Update4b_20191210.iso) | cfc41596154563f60b74320634589721fd1110c87e04632068bc5234aada342e |
